...
SCHEDULE = {
    ...
    "Середа":    ["Укр. Мова","Мистецтво","Укр. Літ","Фізика","Географія"],  # 6 урок прибрали
    "Четвер":    ["Історія","Алгебра","Хімія","Історія України","Біологія","Технології","Англ. Мова"],  # було Інформ./Технол.
    "П'ятниця":  ["Історія України","Зар. Літ","Астрономія","Укр. Мова","Фізкультура"],  # було Укр. Мова (дод)
}
